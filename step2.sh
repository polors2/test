...
# Display header
echo -e "${CYAN}MDM Dual Boot Step 2. Block MDM Domains, remove config profiles, and disable notifications${NC}"
echo ""
...
select opt in "${options[@]}"; do
    case $opt in
        "Bypass MDM from Recovery")
            ...
            if [ -d "/Volumes/Data - Data" ]; then
                diskutil rename "Data - Data" "Data"
            fi
